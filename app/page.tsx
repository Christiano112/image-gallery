    ...
    <>
      ...
      <header className="container mx-auto flex items-center justify-center gap-4 my-4">
        <h1 className="text-2xl sm:text-3xl font-semibold text-center text-primary">
          Welcome to <span className="bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-primary">ChrixGallery</span>
        </h1>
      </header>
      <main className="p-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-6 select-none" title="Login To Use Drag and Drop">
        {data.map((item: any) => (
